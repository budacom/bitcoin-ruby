...
module BitcoinOld
  module Protocol
    ...
    autoload :ScriptWitness, 'bitcoin_old/protocol/script_witness'
    autoload :TxIn,          'bitcoin_old/protocol/txin'
    autoload :TxOut,         'bitcoin_old/protocol/txout'
    autoload :Tx,            'bitcoin_old/protocol/tx'
    autoload :Block,         'bitcoin_old/protocol/block'
    autoload :Addr,          'bitcoin_old/protocol/address'
    autoload :Reject,        'bitcoin_old/protocol/reject'
    autoload :Version,       'bitcoin_old/protocol/version'
    autoload :AuxPow,        'bitcoin_old/protocol/aux_pow'
    autoload :PartialMerkleTree,  'bitcoin_old/protocol/partial_merkle_tree'

    autoload :Handler, 'bitcoin_old/protocol/handler'
    autoload :Parser,  'bitcoin_old/protocol/parser'
    ...
    def self.pkt(command, payload)
      ...
      pkt << BitcoinOld.network[:magic_head].force_encoding(BINARY)
    ...
    def self.version_pkt(from_id, from=nil, to=nil, last_block=nil, time=nil, user_agent=nil, version=nil)
      opts = if from_id.is_a?(Hash)
        ...
        STDERR.puts "BitcoinOld::Protocol.version_pkt - API deprecated. please change it soon.."
        {
