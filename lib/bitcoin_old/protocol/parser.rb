  ...
  module Protocol
    ...
    class Parser
      ...
      def parse_version(payload)
        @version = BitcoinOld::Protocol::Version.parse(payload)
      ...
      def handle_mempool_request(*_)
        ...
        return unless (
          @version.fields[:services] & BitcoinOld::Protocol::Version::NODE_NETWORK
      ...
      def handle_reject(payload)
        ...
        @h.on_reject BitcoinOld::Protocol::Reject.parse(payload)
      end
      ...
      def parse_buffer
        head_magic = BitcoinOld.network[:magic_head]
        head_size  = 24
