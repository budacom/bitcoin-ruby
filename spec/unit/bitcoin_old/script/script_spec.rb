...
describe BitcoinOld::Script do
  ...
  #   funds.
  # @param keys [Array<BitcoinOld::Key>] key pairs for unlocking funds.
  # @return [Array] previous transaction, transaction, redeem script, and sig
  #   hash.
  def build_p2sh_multisig_tx(num_to_unlock, *keys)
    redeem_script = BitcoinOld::Script.to_multisig_script(
      num_to_unlock, *keys.map(&:pub)
    )
    p2sh_address = BitcoinOld.hash160_to_p2sh_address(
      BitcoinOld.hash160(redeem_script.hth)
    )
    ...
    tx = build_tx do |t|
      ...
      t.output do |o|
        o.to BitcoinOld::Key.generate.addr
        o.value 50e8
      end
    end
  ...
  describe 'serialization' do
    it '#to_string' do
      expect(BitcoinOld::Script.new(SCRIPT[0]).to_string)
      ...
      expect(BitcoinOld::Script.new(SCRIPT[1]).to_string)
      ...
      # BitcoinOld::Script.new([123].pack('C')).to_string.should == '(opcode 123)'
      expect(BitcoinOld::Script.new([176].pack('C')).to_string).to eq('OP_NOP1')
      expect(BitcoinOld::Script.from_string('1 OP_DROP 2').to_string).to eq('1 OP_DROP 2')

      expect(BitcoinOld::Script.from_string('4b').to_string).to eq('4b')
      expect(BitcoinOld::Script.from_string('4b').to_payload).to eq("\x01\x4b")
      expect(BitcoinOld::Script.from_string('ff').to_string).to eq('ff')
      expect(BitcoinOld::Script.from_string('ff').to_payload).to eq("\x01\xff")
      expect(BitcoinOld::Script.from_string('ffff').to_string).to eq('ffff')

      expect(
        BitcoinOld::Script.from_string('ff' * (BitcoinOld::Script::OP_PUSHDATA1 - 1))
          .to_payload[0]
      ).to eq([BitcoinOld::Script::OP_PUSHDATA1 - 1].pack('C*'))
      expect(
        BitcoinOld::Script.from_string('ff' * BitcoinOld::Script::OP_PUSHDATA1)
          .to_payload[0..1]
      ).to eq([BitcoinOld::Script::OP_PUSHDATA1, BitcoinOld::Script::OP_PUSHDATA1].pack('C*'))
      expect(
        BitcoinOld::Script.from_string('ff' * (BitcoinOld::Script::OP_PUSHDATA1 + 1))
          .to_payload[0..1]
      ).to eq([BitcoinOld::Script::OP_PUSHDATA1, BitcoinOld::Script::OP_PUSHDATA1 + 1].pack('C*'))
      expect(BitcoinOld::Script.from_string('ff' * 0xff).to_payload[0..1])
        .to eq([BitcoinOld::Script::OP_PUSHDATA1, 0xff].pack('C*'))
      expect(BitcoinOld::Script.from_string('ff' * (0xff + 1)).to_payload[0..2])
        .to eq([BitcoinOld::Script::OP_PUSHDATA2, 0x00, 0x01].pack('C*'))
      expect(BitcoinOld::Script.from_string('ff' * 0xffff).to_payload[0..2])
        .to eq([BitcoinOld::Script::OP_PUSHDATA2, 0xff, 0xff].pack('C*'))
      expect(BitcoinOld::Script.from_string('ff' * (0xffff + 1)).to_payload[0..4])
        .to eq([BitcoinOld::Script::OP_PUSHDATA4, 0x00, 0x00, 0x01, 0x00].pack('C*'))

      expect(BitcoinOld::Script.from_string('16').to_string).to eq('16')
      expect(BitcoinOld::Script::OP_2_16).to include(BitcoinOld::Script.from_string('16').chunks.first)
      expect(BitcoinOld::Script.from_string('16').to_payload).to eq("\x60")
      expect(BitcoinOld::Script.new("\x60").to_string).to eq('16')

      expect(BitcoinOld::Script.from_string('0:1:16').to_string).to eq('0:1:16')
      expect(BitcoinOld::Script::OP_2_16)
        .not_to include(BitcoinOld::Script.from_string('0:1:16').chunks.first)
      expect(BitcoinOld::Script.from_string('0:1:16').to_payload).to eq("\x01\x16")
      expect(BitcoinOld::Script.new("\x01\x16").to_string).to eq('0:1:16')

      expect(BitcoinOld::Script.new("\x4d\x01\x00\x02").to_string).to eq('77:1:02')
      expect(BitcoinOld::Script.from_string('77:1:02').to_payload).to eq("\x4d\x01\x00\x02")
      expect(BitcoinOld::Script.from_string('77:1:01').to_string).to eq('77:1:01')
      expect(BitcoinOld::Script.from_string('77:2:0101').to_string).to eq('77:2:0101')
      expect(BitcoinOld::Script.from_string('78:1:01').to_string).to eq('78:1:01')
      expect(BitcoinOld::Script.from_string('78:2:0101').to_string).to eq('78:2:0101')
      expect(BitcoinOld::Script.new("\x4e\x01\x00\x00\x00\x02").to_string).to eq('78:1:02')
      expect(BitcoinOld::Script.from_string('78:1:02').to_payload)
        .to eq("\x4e\x01\x00\x00\x00\x02")

      expect(BitcoinOld::Script.new("\x4d\x01\x00").to_string).to eq('77:1:')
      expect(BitcoinOld::Script.from_string('77:1:').to_payload).to eq("\x4d\x01\x00")
      ...
      [
        ...
        expect(BitcoinOld::Script.new(payload).to_string).to eq(string)
        expect(BitcoinOld::Script.new(payload).instance_eval { @parse_invalid })
          .to eq(parse_invalid)
        expect(BitcoinOld::Script.from_string(string).to_payload).to eq(payload)
      end

      expect(BitcoinOld::Script.from_string('(opcode-230) 4 1 2').to_string)
        .to eq('(opcode-230) 4 1 2')
      expect(BitcoinOld::Script.from_string('(opcode 230) 4 1 2').to_string)
        .to eq('(opcode-230) 4 1 2')
      expect(BitcoinOld::Script.from_string('(opcode-65449) 4 1 2').to_string)
      ...
      expect(BitcoinOld::Script.new("\xff\xff\xff\xff").to_string)
        .to eq('OP_INVALIDOPCODE OP_INVALIDOPCODE OP_INVALIDOPCODE OP_INVALIDOPCODE')
      expect(BitcoinOld::Script.from_string(BitcoinOld::Script.new("\xff\xff\xff\xff").to_string).raw)
        .to eq("\xFF\xFF\xFF\xFF")
      expect(BitcoinOld::Script.new("\xff\xff\xff").to_string)
        .to eq('OP_INVALIDOPCODE OP_INVALIDOPCODE OP_INVALIDOPCODE')
      expect(BitcoinOld::Script.from_string(BitcoinOld::Script.new("\xff\xff\xff").to_string).raw)
        .to eq("\xFF\xFF\xFF")
    end

    it 'Script#binary_from_string' do
      str = BitcoinOld::Script.new(SCRIPT[0]).to_string
      expect(BitcoinOld::Script.binary_from_string(str).unpack('H*')[0])
        .to eq(SCRIPT[0].unpack('H*')[0])
      expect(BitcoinOld::Script.new(BitcoinOld::Script.binary_from_string(str)).to_string).to eq(str)

      str = BitcoinOld::Script.new(SCRIPT[1]).to_string
      expect(BitcoinOld::Script.binary_from_string(str).unpack('H*')[0])
      ...
      expect(BitcoinOld::Script.from_string(string).to_string).to eq(string)
      expect(BitcoinOld::Script.from_string('0 OP_DROP 2 3 4').to_string)
        .to eq('0 OP_DROP 2 3 4')
      expect(BitcoinOld::Script.from_string('OP_EVAL').to_string).to eq('OP_NOP1')
      # test opcodes_alias table
      expect(BitcoinOld::Script.from_string('OP_NOP1').to_string).to eq('OP_NOP1')
      expect(BitcoinOld::Script.from_string('OP_NOP').to_string).to eq('OP_NOP')
      expect(BitcoinOld::Script.from_string('1').to_string).to eq('1')
      ...
      [1, 2, 4].each do |n|
        ...
        expect(BitcoinOld::Script.binary_from_string(script))
          .to eq(BitcoinOld::Script.binary_from_string(
                   BitcoinOld::Script.from_string(script).to_string
                 ))
      end

      # expect(BitcoinOld::Script.from_string('-100').to_string).to eq('OP_NOP')
      # expect(BitcoinOld::Script.from_string('100').to_string).to eq('100')

      expect do
        BitcoinOld::Script.from_string('OP_NOP OP_UNKOWN')
      end.to raise_error(BitcoinOld::Script::ScriptOpcodeError,
  ...
  describe 'get keys/addresses' do
    it '#get_pubkey' do
      expect(BitcoinOld::Script.new(SCRIPT[0]).get_pubkey)
        .to eq('0411db93e1dcdb8a016b49840f8c53bc1eb68a382e97b1482ecad7b148a69' \
               '09a5cb2e0eaddfb84ccf9744464f82e160bfa9b8b64f9d4c03f999b8643f6' \
               '56b412a3')
    end
    ...
    it '#get_pubkey_address' do
      expect(BitcoinOld::Script.new(SCRIPT[0]).get_pubkey_address)
        .to eq('12cbQLTFMXRnSzktFkuoG3eHoMeFtpTu3S')
    end

    it '#get_hash160' do
      expect(BitcoinOld::Script.new(SCRIPT[2]).get_hash160)
      ...
      expect(BitcoinOld::Script.new(SCRIPT[7]).get_hash160)
        .to eq('1e205151c90c16475363d11b7b8c235cf6c7d695')
    end

    it '#get_hash160_address' do
      expect(BitcoinOld::Script.new(SCRIPT[2]).get_hash160_address)
    ...
    it '#get_multisig_pubkeys' do
      ...
      expect(BitcoinOld::Script.new(SCRIPT[3]).get_multisig_pubkeys).to eq(expected)
    ...
    it '#get_multisig_addresses' do
      ...
      expect(BitcoinOld::Script.new(SCRIPT[3]).get_multisig_addresses).to eq(expected)

      expected = %w[
        1F2Nnyn7niMcheiYhkHrkc18aDxEkFowy5
        1EE7JGimkV7QqyHwXDJvk3b1yEN4ZUWeqx
      ]
      expect(BitcoinOld::Script.new(SCRIPT[4]).get_multisig_addresses).to eq(expected)
      ...
      output =
        ...
        '2 OP_CHECKMULTISIG'
      expect(
        BitcoinOld::Script.from_string(output).get_multisig_addresses
      ).to eq(['1NdB761LmTmrJixxp93nz7pEiCx5cKPW44', nil])
    end

    it '#get_p2sh_address' do
      expect(BitcoinOld::Script.new(SCRIPT[5]).get_p2sh_address)
        .to eq('3FDuvkgzsW7LpzL9RBjtjvL7bFXCEeZ7xi')
    end

    it '#get_address' do
      expect(BitcoinOld::Script.new(SCRIPT[0]).get_address)
        .to eq('12cbQLTFMXRnSzktFkuoG3eHoMeFtpTu3S')
      expect(BitcoinOld::Script.new(SCRIPT[1]).get_address).to be_nil
      expect(BitcoinOld::Script.new(SCRIPT[2]).get_address)
        .to eq('139k1g5rtTsL4aGZbcASH3Fv3fUh9yBEdW')
      expect(BitcoinOld::Script.new(SCRIPT[3]).get_address)
        .to eq('1JiaVc3N3U3CwwcLtzNX1Q4eYfeYxVjtuj')
      expect(BitcoinOld::Script.new(SCRIPT[4]).get_address)
        .to eq('1F2Nnyn7niMcheiYhkHrkc18aDxEkFowy5')
      expect(BitcoinOld::Script.new(SCRIPT[5]).get_address)
        .to eq('3FDuvkgzsW7LpzL9RBjtjvL7bFXCEeZ7xi')
      expect(BitcoinOld::Script.new(SCRIPT[7]).get_address)
        .to eq('bc1qrcs9z5wfpstyw5mr6ydhhrprtnmv0454y6laym')
      expect(BitcoinOld::Script.new(SCRIPT[8]).get_address)
        .to eq('bc1qt5d4dd3aw98whe2zxz2jtayykl5ada5xkdupkmmpa7f96ekk76sqvmrunq')
    end

    it '#get_addresses' do
      expect(BitcoinOld::Script.new(SCRIPT[0]).get_addresses)
        .to eq(['12cbQLTFMXRnSzktFkuoG3eHoMeFtpTu3S'])
      expect(BitcoinOld::Script.new(SCRIPT[3]).get_addresses)
        .to eq(%w[1JiaVc3N3U3CwwcLtzNX1Q4eYfeYxVjtuj
                  19Fm2gY7qDTXriNTEhFY2wjxbHna3Gvenk
                  1B6k6g1d2L975i7beAbiBRxfBWhxomPxvy])
      expect(BitcoinOld::Script.new(SCRIPT[7]).get_addresses)
        .to eq(['bc1qrcs9z5wfpstyw5mr6ydhhrprtnmv0454y6laym'])
    end

    it 'should get op_return data' do
      expect(BitcoinOld::Script.new(SCRIPT[6]).get_op_return_data).to eq('deadbeef')
      expect(BitcoinOld::Script.new(SCRIPT[1]).get_op_return_data).to be_nil
      expect(BitcoinOld::Script.from_string('OP_RETURN').get_op_return_data).to be_nil
      expect(BitcoinOld::Script.from_string('OP_RETURN dead beef').get_op_return_data)
        .to be_nil
      expect(BitcoinOld::Script.from_string('OP_RETURN deadbeef').get_op_return_data)
        .to eq('deadbeef')
      expect(BitcoinOld::Script.from_string('OP_RETURN OP_CHECKSIG').get_op_return_data)
        .to eq('ac00')
    end
  end
  ...
  describe 'determine type' do
    it '#is_standard?' do
      expect(BitcoinOld::Script.new(SCRIPT[0]).is_standard?).to be true
      expect(BitcoinOld::Script.new(SCRIPT[1]).is_standard?).to be false
      expect(BitcoinOld::Script.new(SCRIPT[2]).is_standard?).to be true
      expect(BitcoinOld::Script.new(SCRIPT[3]).is_standard?).to be true
      expect(BitcoinOld::Script.new(SCRIPT[4]).is_standard?).to be true
      expect(BitcoinOld::Script.new(SCRIPT[5]).is_standard?).to be true
      expect(BitcoinOld::Script.new(SCRIPT[6]).is_standard?).to be true
      expect(BitcoinOld::Script.new(SCRIPT[7]).is_standard?).to be true
      expect(BitcoinOld::Script.new(SCRIPT[8]).is_standard?).to be true
    end

    it '#is_pubkey?' do
      expect(BitcoinOld::Script.new(SCRIPT[0]).is_pubkey?).to be true
      expect(BitcoinOld::Script.new(SCRIPT[1]).is_pubkey?).to be false
      expect(BitcoinOld::Script.new(SCRIPT[2]).is_pubkey?).to be false
      expect(BitcoinOld::Script.new(SCRIPT[3]).is_pubkey?).to be false
      expect(BitcoinOld::Script.new(SCRIPT[4]).is_send_to_ip?).to be false
      expect(BitcoinOld::Script.new(SCRIPT[5]).is_pubkey?).to be false
      expect(BitcoinOld::Script.new(SCRIPT[6]).is_pubkey?).to be false
      expect(BitcoinOld::Script.new(SCRIPT[7]).is_pubkey?).to be false
      expect(BitcoinOld::Script.new(SCRIPT[8]).is_pubkey?).to be false

      # testnet aba0441c4c9933dcd7db789c39053739ec435ab742ed2c23c05f22f1488c0bfd
      expect(BitcoinOld::Script.from_string('0 OP_CHECKSIG').is_pubkey?)
        .to be false
    end

    it '#is_hash160?' do
      expect(BitcoinOld::Script.new(SCRIPT[0]).is_hash160?).to be false
      expect(BitcoinOld::Script.new(SCRIPT[1]).is_pubkey?).to be false
      expect(BitcoinOld::Script.new(SCRIPT[2]).is_hash160?).to be true
      expect(
        BitcoinOld::Script.from_string('OP_DUP OP_HASH160 0 OP_EQUALVERIFY OP_CHECKSIG')
          .is_hash160?
      ).to be false
      expect(BitcoinOld::Script.new(SCRIPT[5]).is_hash160?).to be false
      expect(BitcoinOld::Script.new(SCRIPT[6]).is_hash160?).to be false
      expect(BitcoinOld::Script.new(SCRIPT[7]).is_hash160?).to be false
      expect(BitcoinOld::Script.new(SCRIPT[8]).is_hash160?).to be false
    end

    it '#is_multisig?' do
      expect(BitcoinOld::Script.new(SCRIPT[3]).is_multisig?).to be true
      expect(BitcoinOld::Script.new(SCRIPT[4]).is_multisig?).to be true
      expect(BitcoinOld::Script.new(SCRIPT[0]).is_multisig?).to be false
      expect(BitcoinOld::Script.new(SCRIPT[6]).is_multisig?).to be false
      expect(BitcoinOld::Script.new(SCRIPT[7]).is_multisig?).to be false
      expect(BitcoinOld::Script.new(SCRIPT[8]).is_multisig?).to be false
      expect(
        BitcoinOld::Script.new("OP_DUP OP_DROP 2 #{PUBKEYS[0..2].join(' ')} 3 OP_CHECKMULTISIG")
          .is_multisig?
      ).to be false
      expect(BitcoinOld::Script.new('OP_DROP OP_CHECKMULTISIG').is_multisig?)
        .to be false
      expect(
    ...
    it '#is_p2sh?' do
      expect(BitcoinOld::Script.new(SCRIPT[0]).is_p2sh?).to be false
      expect(BitcoinOld::Script.new(SCRIPT[1]).is_p2sh?).to be false
      expect(BitcoinOld::Script.new(SCRIPT[2]).is_p2sh?).to be false
      expect(BitcoinOld::Script.new(SCRIPT[3]).is_p2sh?).to be false
      expect(BitcoinOld::Script.new(SCRIPT[4]).is_p2sh?).to be false
      expect(BitcoinOld::Script.new(SCRIPT[5]).is_p2sh?).to be true
      expect(BitcoinOld::Script.new(SCRIPT[6]).is_p2sh?).to be false
      expect(BitcoinOld::Script.new(SCRIPT[7]).is_p2sh?).to be false
      expect(BitcoinOld::Script.new(SCRIPT[8]).is_p2sh?).to be false
      expect(
        BitcoinOld::Script.from_string(
    ...
    it '#is_op_return?' do
      expect(BitcoinOld::Script.new(SCRIPT[0]).is_op_return?).to be false
      expect(BitcoinOld::Script.new(SCRIPT[1]).is_op_return?).to be false
      expect(BitcoinOld::Script.new(SCRIPT[2]).is_op_return?).to be false
      expect(BitcoinOld::Script.new(SCRIPT[3]).is_op_return?).to be false
      expect(BitcoinOld::Script.new(SCRIPT[4]).is_op_return?).to be false
      expect(BitcoinOld::Script.new(SCRIPT[5]).is_op_return?).to be false
      expect(BitcoinOld::Script.new(SCRIPT[6]).is_op_return?).to be true
      expect(BitcoinOld::Script.new(SCRIPT[7]).is_op_return?).to be false
      expect(BitcoinOld::Script.new(SCRIPT[8]).is_op_return?).to be false
      expect(BitcoinOld::Script.from_string('OP_RETURN dead beef').is_op_return?)
        .to be false
      expect(BitcoinOld::Script.from_string('OP_RETURN deadbeef').is_op_return?)
        .to be true
      expect(BitcoinOld::Script.from_string('OP_RETURN OP_CHECKSIG').is_op_return?)
        .to be true
    end

    it '#is_witness_v0_keyhash?' do
      expect(BitcoinOld::Script.new(SCRIPT[0]).is_witness_v0_keyhash?).to be false
      expect(BitcoinOld::Script.new(SCRIPT[1]).is_witness_v0_keyhash?).to be false
      expect(BitcoinOld::Script.new(SCRIPT[2]).is_witness_v0_keyhash?).to be false
      expect(BitcoinOld::Script.new(SCRIPT[3]).is_witness_v0_keyhash?).to be false
      expect(BitcoinOld::Script.new(SCRIPT[4]).is_witness_v0_keyhash?).to be false
      expect(BitcoinOld::Script.new(SCRIPT[5]).is_witness_v0_keyhash?).to be false
      expect(BitcoinOld::Script.new(SCRIPT[6]).is_witness_v0_keyhash?).to be false
      expect(BitcoinOld::Script.new(SCRIPT[7]).is_witness_v0_keyhash?).to be true
      expect(BitcoinOld::Script.new(SCRIPT[8]).is_witness_v0_keyhash?).to be false
    end

    it '#is_witness_v0_scripthash?' do
      expect(BitcoinOld::Script.new(SCRIPT[0]).is_witness_v0_scripthash?).to be false
      expect(BitcoinOld::Script.new(SCRIPT[1]).is_witness_v0_scripthash?).to be false
      expect(BitcoinOld::Script.new(SCRIPT[2]).is_witness_v0_scripthash?).to be false
      expect(BitcoinOld::Script.new(SCRIPT[3]).is_witness_v0_scripthash?).to be false
      expect(BitcoinOld::Script.new(SCRIPT[4]).is_witness_v0_scripthash?).to be false
      expect(BitcoinOld::Script.new(SCRIPT[5]).is_witness_v0_scripthash?).to be false
      expect(BitcoinOld::Script.new(SCRIPT[6]).is_witness_v0_scripthash?).to be false
      expect(BitcoinOld::Script.new(SCRIPT[7]).is_witness_v0_scripthash?).to be false
      expect(BitcoinOld::Script.new(SCRIPT[8]).is_witness_v0_scripthash?).to be true
    end

    it '#type' do
      expect(BitcoinOld::Script.new(SCRIPT[0]).type).to eq(:pubkey)
      expect(BitcoinOld::Script.new(SCRIPT[1]).type).to eq(:unknown)
      expect(BitcoinOld::Script.new(SCRIPT[2]).type).to eq(:hash160)
      expect(BitcoinOld::Script.new(SCRIPT[3]).type).to eq(:multisig)
      expect(BitcoinOld::Script.new(SCRIPT[4]).type).to eq(:multisig)
      expect(BitcoinOld::Script.new(SCRIPT[5]).type).to eq(:p2sh)
      expect(BitcoinOld::Script.new(SCRIPT[6]).type).to eq(:op_return)
      expect(BitcoinOld::Script.new(SCRIPT[7]).type).to eq(:witness_v0_keyhash)
      expect(BitcoinOld::Script.new(SCRIPT[8]).type).to eq(:witness_v0_scripthash)
      expect(BitcoinOld::Script.from_string('OP_RETURN OP_CHECKSIG').type)
        .to eq(:op_return)
      expect(BitcoinOld::Script.from_string('OP_RETURN dead beef').type)
        .to eq(:unknown)
    end
  end
  ...
  describe 'generate scripts' do
    it 'should generate pubkey script' do
      expect(BitcoinOld::Script.to_pubkey_script(PUBKEYS[0]))
        .to eq(BitcoinOld::Script.from_string("#{PUBKEYS[0]} OP_CHECKSIG").raw)
      expect(BitcoinOld::Script.to_pubkey_script(PUBKEYS[1]))
        .to eq(BitcoinOld::Script.from_string("#{PUBKEYS[1]} OP_CHECKSIG").raw)
    end

    it 'should generate hash160 script' do
      expect(
        BitcoinOld::Script.to_address_script('16Tc7znw2mfpWcqS84vBFfJ7PyoeHaXSz9')
      ).to eq(['76a9143be0c2daaabbf3d53e47352c19d1e8f047e2f94188ac'].pack('H*'))

      hash160 = BitcoinOld.hash160_from_address('16Tc7znw2mfpWcqS84vBFfJ7PyoeHaXSz9')
      expect(BitcoinOld::Script.to_hash160_script(hash160))
        .to eq(
          BitcoinOld::Script.from_string(
            "OP_DUP OP_HASH160 #{hash160} OP_EQUALVERIFY OP_CHECKSIG"
          ).raw
        )
      expect(BitcoinOld::Script.to_address_script('mr1jU3Adw2pkvxTLvQA4MKpXB9Dynj9cXF'))
        .to be_nil
    end

    it 'should generate multisig script' do
      expect(BitcoinOld::Script.to_multisig_script(2, *PUBKEYS[0..2]))
        .to eq(
          BitcoinOld::Script.from_string(
            "2 #{PUBKEYS[0..2].join(' ')} 3 OP_CHECKMULTISIG"
          ).raw
        )
      expect(BitcoinOld::Script.to_multisig_script(1, *PUBKEYS[0..1]))
        .to eq(
          BitcoinOld::Script.from_string(
      ...
      m = n = 16
      expect(
        BitcoinOld::Script.new(
          BitcoinOld::Script.to_multisig_script(m, *(['a'] * n))
        ).to_string
    ...
    it 'should generate p2sh script' do
      ...
      hash160 = BitcoinOld.hash160_from_address address
      expect(BitcoinOld::Script.to_p2sh_script(hash160))
        .to eq(BitcoinOld::Script.from_string("OP_HASH160 #{hash160} OP_EQUAL").raw)
    end

    it 'to_witness_hash160_script' do
      hash160 = BitcoinOld.hash160(
        '025476c2e83188368da1ff3e292e7acafcdb3566bb0ad253f62fc70f07aeee6357'
      )
      expect(BitcoinOld::Script.to_witness_hash160_script(hash160))
        .to eq(BitcoinOld::Script.new('00141d0f172a0ecb48aee1be1f2687d2963ae33f71a1'.htb).raw)
    end
    ...
    it 'should generate p2wsh script' do
      witness_script =
        ...
        '5ea465ac'
      sha256 = BitcoinOld.sha256(witness_script)
      expect(BitcoinOld::Script.to_witness_p2sh_script(sha256))
        .to eq(BitcoinOld::Script.new('00205d1b56b63d714eebe542309525f484b7e9d6f686b3781' \
                          'b6f61ef925d66d6f6a0'.htb).raw)
    end

    it 'should generate op_return script' do
      expect(BitcoinOld::Script.to_op_return_script('deadbeef')).to eq(SCRIPT[6])
      expect(BitcoinOld::Script.to_op_return_script)
        .to eq(BitcoinOld::Script.from_string('OP_RETURN').raw)
    end

    it 'should determine type for address script' do
      address = '16Tc7znw2mfpWcqS84vBFfJ7PyoeHaXSz9'
      hash160 = BitcoinOld.hash160_from_address address
      expect(BitcoinOld::Script.to_address_script(address))
        .to eq(
          BitcoinOld::Script.from_string(
            "OP_DUP OP_HASH160 #{hash160} OP_EQUALVERIFY OP_CHECKSIG"
          ).raw
  ...
  describe 'generate script sigs' do
    ...
    it 'should generate pubkey script sig' do
      ...
      expect(BitcoinOld::Script.to_pubkey_script_sig(sig, pub))
    ...
    it 'should support different hash types' do
      ...
      expect(BitcoinOld::Script.to_pubkey_script_sig(sig, pub, hash_type))
        .to eq(expected_script)
    end

    it 'should generate multisig script sig' do
      hash_type = BitcoinOld::Script::SIGHASH_TYPE[:none]
      expected_script =
      ...
      expect(BitcoinOld::Script.to_multisig_script_sig(sig, sig, hash_type))
        .to eq(expected_script)
    end
  end
  ...
  describe 'signatures_count' do
    it 'should be zero in data-only scripts' do
      [false, true].each do |accurate|
        expect(BitcoinOld::Script.from_string('').sigops_count_accurate(accurate))
          .to eq(0)
        expect(
          BitcoinOld::Script.from_string('DEADBEEF').sigops_count_accurate(accurate)
        ).to eq(0)
        expect(
          BitcoinOld::Script.from_string('DEAD BEEF').sigops_count_accurate(accurate)
        ).to eq(0)
        expect(
          BitcoinOld::Script.from_string('DE AD BE EF').sigops_count_accurate(accurate)
        ).to eq(0)
        expect(
          BitcoinOld::Script.from_string('OP_NOP').sigops_count_accurate(accurate)
        ).to eq(0)
        expect(
          BitcoinOld::Script.from_string('0').sigops_count_accurate(accurate)
        ).to eq(0)
        expect(
          BitcoinOld::Script.from_string('0 1').sigops_count_accurate(accurate)
        ).to eq(0)
        expect(
          BitcoinOld::Script.from_string('0 1 2 3').sigops_count_accurate(accurate)
        ).to eq(0)
      end
    end
    ...
    it 'should count sigops' do
      [false, true].each do |accurate|
        expect(
          BitcoinOld::Script.from_string('OP_CHECKSIG').sigops_count_accurate(accurate)
        ).to eq(1)
        expect(
          BitcoinOld::Script.from_string('OP_CHECKSIGVERIFY')
            .sigops_count_accurate(accurate)
        ).to eq(1)
        expect(
          BitcoinOld::Script.from_string('OP_CHECKSIG OP_CHECKSIGVERIFY')
            .sigops_count_accurate(accurate)
        ).to eq(2)
        expect(
          BitcoinOld::Script.from_string(
    ...
    it 'should count multisig as 20 sigops in legact inaccurate mode' do
      expect(
        BitcoinOld::Script.from_string('OP_CHECKMULTISIG')
          .sigops_count_accurate(false)
      ).to eq(20)
      expect(
        BitcoinOld::Script.from_string('OP_CHECKMULTISIGVERIFY')
          .sigops_count_accurate(false)
      ).to eq(20)
      expect(
        BitcoinOld::Script.from_string('OP_CHECKMULTISIG OP_CHECKMULTISIGVERIFY')
          .sigops_count_accurate(false)
      ).to eq(40)
      expect(
        BitcoinOld::Script.from_string('1 OP_CHECKMULTISIG')
          .sigops_count_accurate(false)
      ).to eq(20)
      expect(
        BitcoinOld::Script.from_string('5 OP_CHECKMULTISIG')
          .sigops_count_accurate(false)
      ).to eq(20)
      expect(
        BitcoinOld::Script.from_string('40 OP_CHECKMULTISIG')
          .sigops_count_accurate(false)
      ).to eq(20)
    end
    ...
    it 'should count multisig accurately using number of pubkeys' do
      ...
      expect(
        BitcoinOld::Script.from_string('1 OP_CHECKMULTISIGVERIFY')
          .sigops_count_accurate(true)
      ).to eq(1)
      expect(
        BitcoinOld::Script.from_string('2 OP_CHECKMULTISIG')
          .sigops_count_accurate(true)
      ).to eq(2)
      expect(
        BitcoinOld::Script.from_string('2 OP_CHECKMULTISIGVERIFY')
          .sigops_count_accurate(true)
      ).to eq(2)
      expect(
        BitcoinOld::Script.from_string('15 OP_CHECKMULTISIG')
          .sigops_count_accurate(true)
      ).to eq(15)
      expect(
        BitcoinOld::Script.from_string('15 OP_CHECKMULTISIGVERIFY')
          .sigops_count_accurate(true)
      ).to eq(15)
      expect(
        BitcoinOld::Script.from_string('16 OP_CHECKMULTISIG')
          .sigops_count_accurate(true)
      ).to eq(16)
      expect(
        BitcoinOld::Script.from_string('16 OP_CHECKMULTISIGVERIFY')
          .sigops_count_accurate(true)
      ).to eq(16)
      expect(
        BitcoinOld::Script.from_string('4 OP_CHECKMULTISIG 7 OP_CHECKMULTISIGVERIFY')
          .sigops_count_accurate(true)
      ).to eq(11)
    end
    ...
    it 'should count multisig as 20 sigops when pubkey count is not ' \
      ...
      expect(
        BitcoinOld::Script.from_string(
          "#{BitcoinOld::Script::OP_PUSHDATA1}:1:01 OP_CHECKMULTISIG"
        ).sigops_count_accurate(true)
      ).to eq(20)
      expect(
        BitcoinOld::Script.from_string(
          "#{BitcoinOld::Script::OP_PUSHDATA1}:1:02 OP_CHECKMULTISIGVERIFY"
        ).sigops_count_accurate(true)
      ).to eq(20)
    end
    ...
    it 'should count multisig as 20 sigops in accurate mode when the pubkey ' \
      ...
      expect(
        BitcoinOld::Script.from_string('0 OP_CHECKMULTISIG')
          .sigops_count_accurate(true)
      ).to eq(20)
      expect(
        BitcoinOld::Script.from_string('0 OP_CHECKMULTISIGVERIFY')
          .sigops_count_accurate(true)
      ).to eq(20)
      expect(
        BitcoinOld::Script.from_string('0 OP_CHECKMULTISIG 0 OP_CHECKMULTISIGVERIFY')
          .sigops_count_accurate(true)
      ).to eq(40)
      expect(
        BitcoinOld::Script.from_string('DEADBEEF OP_CHECKMULTISIG')
          .sigops_count_accurate(true)
      ).to eq(20)
      expect(
        BitcoinOld::Script.from_string(
          "#{BitcoinOld::Script::OP_PUSHDATA1}:1:11 OP_CHECKMULTISIG"
        ).sigops_count_accurate(true)
      ).to eq(20)
    end
    ...
    it 'should extract signature count from P2SH scriptSig' do
      ...
      script = BitcoinOld::Script.from_string(
      ...
      serialized_script =
        BitcoinOld::Script.new('').append_pushdata(script.to_binary)

      # If empty should return 0.
      expect(BitcoinOld::Script.from_string('').sigops_count_for_p2sh).to eq(0)

      # If ends with OP_N
      expect(BitcoinOld::Script.from_string('0').sigops_count_for_p2sh).to eq(0)
      expect(BitcoinOld::Script.from_string('1').sigops_count_for_p2sh).to eq(0)
      expect(BitcoinOld::Script.from_string('5').sigops_count_for_p2sh).to eq(0)
      expect(BitcoinOld::Script.from_string('16').sigops_count_for_p2sh).to eq(0)

      # If ends with opcode
      expect(BitcoinOld::Script.from_string('OP_NOP').sigops_count_for_p2sh)
        .to eq(0)
      expect(BitcoinOld::Script.from_string('OP_HASH160').sigops_count_for_p2sh)
        .to eq(0)
      expect(BitcoinOld::Script.from_string('OP_CHECKSIG').sigops_count_for_p2sh)
        .to eq(0)
      expect(BitcoinOld::Script.from_string('DEADBEEF OP_NOP').sigops_count_for_p2sh)
        .to eq(0)
      expect(
        BitcoinOld::Script.from_string('DEADBEEF OP_HASH160').sigops_count_for_p2sh
      ).to eq(0)
      expect(
        BitcoinOld::Script.from_string('DEADBEEF OP_CHECKSIG').sigops_count_for_p2sh
      ).to eq(0)
      ...
      expect(
        BitcoinOld::Script.new(
          BitcoinOld::Script.from_string('DEADBEEF CAFEBABE').to_binary +
          serialized_script.to_binary
        ).sigops_count_for_p2sh
      ).to eq(12)
      expect(
        BitcoinOld::Script.new(
          BitcoinOld::Script.from_string('DEADBEEF 1').to_binary +
          serialized_script.to_binary
        ).sigops_count_for_p2sh
      ).to eq(12)
      ...
      expect(
        BitcoinOld::Script.new(
          serialized_script.to_binary +
          BitcoinOld::Script.new('').append_pushdata(
            BitcoinOld::Script.from_string('DEADBEEF').to_binary
          ).to_binary
        ).sigops_count_for_p2sh
      ).to eq(0)
      expect(
        BitcoinOld::Script.new(
          serialized_script.to_binary +
          BitcoinOld::Script.from_string('1').to_binary
        ).sigops_count_for_p2sh
      ).to eq(0)
    end

    it 'should count sigops up until an invalid OP_PUSHDATA' do
      script_binary = BitcoinOld::Protocol.read_binary_file(
        fixtures_path(
          'txscript-invalid-too-many-sigops-followed-by-invalid-pushdata.bin'
        )
      )
      expect(
        BitcoinOld::Script.new(script_binary).sigops_count_accurate(false)
      ).to eq(39_998)
    end
  end
  ...
  it '#run' do
    ...
    expect(BitcoinOld::Script.new(script).run).to be true

    expect(BitcoinOld::Script.from_string('1 OP_DUP OP_DROP 1 OP_EQUAL').run)
      .to be true
    expect(BitcoinOld::Script.from_string('1 OP_DUP OP_DROP 1 OP_EQUAL').run)
      .to be true
    expect(BitcoinOld::Script.from_string('foo OP_DUP OP_DROP foo OP_EQUAL').run)
      .to be true
    expect(BitcoinOld::Script.from_string('bar foo OP_DUP OP_DROP bar OP_EQUAL').run)
      .to be false

    expect(BitcoinOld::Script.from_string('1 OP_DROP 2').run).to be true

    # testnet3 tx:
    # 5dea81f9d9d2ea6d06ce23ff225d1e240392519017643f75c96fa2e4316d948a
    script =
      BitcoinOld::Script.new(['0063bac0d0e0f0f1f2f3f3f4ff675168'].pack('H*'))
  ...
  it 'should run op_checkmultisig p2sh script with empty signature' do
    ...
    tx1 = BitcoinOld::Protocol::Tx.new(
    ...
    tx2 = BitcoinOld::Protocol::Tx.new(
  ...
  it 'should debug script branches (OP_IF/NOTIF/ELSE/ENDIF) correctly' do
    script = BitcoinOld::Script.from_string('1 OP_NOTIF OP_RETURN OP_ENDIF')
    script.run {}
    expected = [
      [], 'OP_1',
      [1], 'OP_NOTIF',
    ...
    script = BitcoinOld::Script.from_string('1 OP_IF OP_RETURN OP_ENDIF')
    script.run {}
    expected = [
      [], 'OP_1',
      [1], 'OP_IF',
  ...
  it 'should not execute p2sh recursively' do
    ...
    script = BitcoinOld::Script.from_string(script_sig + ' ' + pk_script)
    expect(script.run).to be true
  end

  it '#sort_p2sh_multisig_signatures 3-of-3' do
    keys = Array.new(3) { BitcoinOld::Key.generate }
    ...
    [0, 1, 2].permutation do |order|
      script_sig = BitcoinOld::Script.to_p2sh_multisig_script_sig(redeem_script)
      order.each do |i|
        script_sig = BitcoinOld::Script.add_sig_to_multisig_script_sig(
          sigs[i], script_sig
        )
      end
      script_sig = BitcoinOld::Script.sort_p2sh_multisig_signatures(
        script_sig, sig_hash
      )
  ...
  describe 'Implements BIP62' do
    it 'tests for incorrectly encoded S-values in signatures' do
      ...
      expect(BitcoinOld::Script.is_low_der_signature?(sig_orig)).to be true
      ...
      expect(BitcoinOld::Script.is_low_der_signature?(sig.pack('C*'))).to be false
    end

    it 'enforces rules 3 and 4' do
      expect(
        BitcoinOld::Script.new([75].pack('C') + 'A' * 75).pushes_are_canonical?
      ).to be true
      expect(
        BitcoinOld::Script.new(
          [BitcoinOld::Script::OP_PUSHDATA1, 75].pack('CC') + 'A' * 75
        ).pushes_are_canonical?
      ).to be false
      expect(
        BitcoinOld::Script.new(
          [BitcoinOld::Script::OP_PUSHDATA2, 255].pack('Cv') + 'A' * 255
        ).pushes_are_canonical?
      ).to be false
      expect(
        BitcoinOld::Script.new(
          [BitcoinOld::Script::OP_PUSHDATA4, 1645].pack('CV') + 'A' * 1645
        ).pushes_are_canonical?
      ).to be false
    end
  end
  ...
  describe 'Implements BIP66' do
    ...
    def build_crediting_tx(script_pk)
      tx = BitcoinOld::Protocol::Tx.new
      input = BitcoinOld::Protocol::TxIn.new(
        nil, 0xffffffff, 2, "\x00\x00"
      )
      output = BitcoinOld::Protocol::TxOut.new(0, script_pk)
      tx.add_in(input)
      tx.add_out(output)
      BitcoinOld::Protocol::Tx.new(tx.to_payload)
    end
    ...
    def build_spending_tx(script_sig, tx_credit)
      ...
      output = BitcoinOld::Protocol::TxOut.new(0, '')
      tx.add_in(input)
      tx.add_out(output)
      BitcoinOld::Protocol::Tx.new(tx.to_payload)
    end
    ...
    def run_script_test(script_sig_str, script_pk_str, opts = {})
      script_sig = BitcoinOld::Script.from_string(script_sig_str)
      script_pk = BitcoinOld::Script.from_string(script_pk_str)
