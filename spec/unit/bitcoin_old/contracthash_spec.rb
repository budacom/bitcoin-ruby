...
describe 'BitcoinOld::ContractHash' do
  it 'should generate and claim' do
    ...
    # protocol.
    nonce, redeem_script, p2sh_address = BitcoinOld::ContractHash.generate(
    ...
    # transaction.
    key = BitcoinOld::ContractHash.claim(
    ...
    script = BitcoinOld::Script.new([redeem_script].pack('H*'))
    pubkey = BitcoinOld::Key.new(
