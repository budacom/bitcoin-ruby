...
describe BitcoinOld::ExtKey do
  describe 'Test Vector 1' do
    let(:master_key) do
      BitcoinOld::ExtKey.generate_master('000102030405060708090a0b0c0d0e0f'.htb)
    end
  ...
  describe 'Test Vector 2' do
    let(:master_key) do
      BitcoinOld::ExtKey.generate_master(
  ...
  describe 'import from base58 address' do
    it 'import private key' do
      # normal key
      key = BitcoinOld::ExtKey.from_base58(
    ...
    it 'import public key' do
      # normal key
      key = BitcoinOld::ExtPubkey.from_base58(
