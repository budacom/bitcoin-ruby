...
describe 'BitcoinOld::Protocol::Parser (getblocks)' do
  # Mock handler interface
  class GetblocksHandler < BitcoinOld::Protocol::Handler
  ...
  it 'builds getblocks' do
    ...
    expect(BitcoinOld::Protocol.getblocks_pkt(70_001, handler.locator).hth)
      .to eq(pkt.hth)
  end
end
