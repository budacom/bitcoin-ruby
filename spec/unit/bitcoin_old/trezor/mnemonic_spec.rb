...
describe 'BitcoinOld::Trezor::Mnemonic' do
  ...
  it 'test vectors' do
    [
      ...
      mnemonic = BitcoinOld::Trezor::Mnemonic.to_mnemonic([data].pack('H*'))
      expect(mnemonic).to eq(expected_mnemonic)
      expect(BitcoinOld::Trezor::Mnemonic.to_seed(expected_mnemonic, 'TREZOR'))
        .to eq(expected_seed)
    end
  end
end
